...
PHASE1_SWITCH_SCHEMA: List[SwitchDef] = [
    ...
    {
        "id": "overhang",
        "title_key": "switch.overhang",
        "default_enabled": False,
        "params": [
            {
                "id": "directional_pct",
                "label_key": "switch.param.overhang_directional_pct",
                "type": "float",
                "default": 50.0,
                "min": 0.0,
                "max": 100.0,
                "decimals": 3,
                "step": 1.0,
                "tooltip_key": "switch.tip.overhang_directional_pct",
            },
            {
                "id": "angle_pct",
                "label_key": "switch.param.overhang_angle_pct",
                "type": "float",
                "default": 22.222,
                "min": 0.0,
                "max": 100.0,
                "decimals": 3,
                "step": 1.0,
                "tooltip_key": "switch.tip.overhang_angle_pct",
            },
            {
                "id": "shadow_pct",
                "label_key": "switch.param.overhang_shadow_pct",
                "type": "float",
                "default": 100.0,
                "min": 0.0,
                "max": 100.0,
                "decimals": 3,
                "step": 1.0,
                "tooltip_key": "switch.tip.overhang_shadow_pct",
            },
            {
                "id": "ray_count",
                "label_key": "switch.param.overhang_ray_count",
                "type": "enum",
                "default": "1",
                "options": ["1", "7", "11"],
                "tooltip_key": "switch.tip.overhang_ray_count",
            },
            {
                "id": "ray_spread_deg",
                "label_key": "switch.param.overhang_ray_spread_deg",
                "type": "float",
                "default": 0.0,
                "min": 0.0,
                "max": 30.0,
                "decimals": 3,
                "step": 1.0,
                "tooltip_key": "switch.tip.overhang_ray_spread_deg",
            },
        ],
    },
    {
